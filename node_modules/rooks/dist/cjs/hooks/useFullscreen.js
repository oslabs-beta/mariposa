...
function useFullscreen(options) {
    ...
    var _b = react_1.useState(Boolean(document[fullscreenControls.fullscreenElement])), isFullscreen = _b[0], setIsFullscreen = _b[1];
    var _c = react_1.useState(document[fullscreenControls.fullscreenElement]), element = _c[0], setElement = _c[1];
    var request = react_1.useCallback(function (element) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var exit = react_1.useCallback(function () { return __awaiter(_this, void 0, void 0, function () {
        var error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var toggle = react_1.useCallback(function (newElement) {
        return Boolean(element) ? exit() : newElement ? request(newElement) : null;
    }, [element]);
    var onChangeDeprecatedHandlerRef = react_1.useRef(noop);
    var onErrorDeprecatedHandlerRef = react_1.useRef(noop);
    // Hack to not break it for everyone
    // Honestly these two functions are tragedy and must be removed in v5
    var onChangeDeprecated = react_1.useCallback(function (callback) {
        warnDeprecatedOnChangeAndOnErrorUsage();
        return (onChangeDeprecatedHandlerRef.current = callback);
    }, []);
    var onErrorDeprecated = react_1.useCallback(function (callback) {
        warnDeprecatedOnChangeAndOnErrorUsage();
        return (onErrorDeprecatedHandlerRef.current = callback);
    }, []);
    useDocumentEventListener_1.useDocumentEventListener(fullscreenControls.fullscreenchange, function (event) {
        var _a;
    ...
    useDocumentEventListener_1.useDocumentEventListener(fullscreenControls.fullscreenerror, function (event) {
        var _a;
