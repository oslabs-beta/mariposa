...
var useDimensionsRef = function (_a) {
    ...
    var _e = react_1.useState(null), dimensions = _e[0], setDimensions = _e[1];
    var _f = react_1.useState(null), node = _f[0], setNode = _f[1];
    var ref = react_1.useCallback(function (nodeFromCallback) {
