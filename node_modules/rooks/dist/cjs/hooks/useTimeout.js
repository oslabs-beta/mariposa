...
function useTimeout(callback_, timeoutDelayMs) {
    ...
    useWarningOnMountInDevelopment_1.useWarningOnMountInDevelopment("useTimeout is deprecated, it will be removed in rooks v7. Please use useTimeoutWhen instead.");
    var _a = react_1.useState(false), isTimeoutActive = _a[0], setIsTimeoutActive = _a[1];
