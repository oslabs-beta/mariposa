...
function useVisibilitySensor(ref, options) {
    useWarningOnMountInDevelopment_1.useWarningOnMountInDevelopment("useVisibilitySensor is deprecated, it will be removed in rooks v7. Please use useInViewRef instead.");
    /*
        Create local state
      */
    var _a = react_1.useReducer(reducer, initialState), localState = _a[0], dispatch = _a[1];
    /*
        Get options
      */
