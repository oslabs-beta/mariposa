...
const { updateDatabase, getAllTables, buildTypeDefs, buildResolvers } = projectDBController;

projectRouter.post('/tables', updateDatabase, getAllTables, buildTypeDefs, buildResolvers, (req: Request, res: Response, next: NextFunction) => {
